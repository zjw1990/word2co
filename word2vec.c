...
int *vocab_hash;
long long vocab_max_size = 100, vocab_size = 0, layer1_size = 100;
    ...
    if (sentence_length == 0) 
    {
      while (1) {
        ...
        if (sample > 0) 
        {
          ...
          {
            //printf("the ran is: %f \n, the word is: %s, which is abandoned\n", ran, vocab[word].word);
            continue;
          }
        }
